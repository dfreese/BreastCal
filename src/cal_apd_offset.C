...
int main(int argc, Char_t *argv[])
{
    ...
    TH1F *tres = new TH1F("tres","Time Resolution After Time walk correction",entries / 10000, -FINELIMIT, FINELIMIT);
    ...
    if (write_out_time_res_plot_flag) {
        ...
        c1->Clear();
        tres->Draw();
        string ps_tres_filename(filebase + ".tres.apdoffset.pdf");
