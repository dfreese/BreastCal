...
//Double_t Sel_GetEhis::finecalc(Double_t uv, Float_t u_cent, Float_t v_cent)
//Int_t Sel_GetEhis::getcrystal(Double_t x, Double_t y, Double_t xpos[64], Double_t ypos[64], Int_t verbose)
