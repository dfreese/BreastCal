...
LDFLAGS = $(DICTLIB) $(shell root-config --glibs) $(shell root-config --libs)  -lMinuit -lSpectrum -lHistPainter -lTreePlayer -lProof -lProofPlayer $(MYLIB) -DARMA_USE_BLAS -DARMA_USE_LAPACK -lblas -llapack -larmadillo
CC =g++
